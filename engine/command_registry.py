...
class CommandRegistry:
    ...
    def available(self, role: str = "player", include_planned: bool = False) -> list[CommandMeta]:
        admin = role in {"admin", "implementor"}; builder = role in {"builder", "admin", "implementor"}
        out=[]
...
def cm(command, aliases=(), category="system", status="placeholder", short="", long="", phase="", admin=False, builder=False, handler=""):
    implemented=status=="implemented"; placeholder=status=="placeholder"
    return CommandMeta(command, tuple(aliases), category, status=status, short_help=short, long_help=long or short, implemented=implemented, placeholder=placeholder, future_phase=phase, admin_only=admin, builder_only=builder, minimum_role="admin" if admin else "builder" if builder else "player", handler=handler)
...
cm("look",("l","glance","scan"),"informational","implemented","Look around or at a target."),cm("examine",("exa",),"informational","implemented","Examine a target."),cm("exits",(),"informational","placeholder","List visible exits."),cm("score",("sc",),"informational","implemented","Display your character sheet summary."),cm("worth",(),"informational","implemented","Show carried gold."),cm("inventory",("inv","i"),"informational","implemented","List carried items."),cm("equipment",("eq",),"informational","implemented","Show worn and wielded equipment."),cm("affects",("aff",),"informational","implemented","List active affects."),cm("skills",("sk",),"character","implemented","List known skills."),cm("spells",("sp",),"magic","implemented","List known spells."),cm("commands",("cmds",),"system","implemented","List available commands."),cm("help",("h",),"system","implemented","Show help for a command."),cm("who",(),"informational","implemented","List online players."),cm("where",(),"informational","placeholder","Show your current location."),cm("weather",(),"informational","placeholder","Show local weather."),cm("time",(),"informational","placeholder","Show world time."),cm("consider",("con",),"informational","placeholder","Assess a target without starting combat."),cm("diagnose",(),"informational","placeholder","Assess a target's condition."),cm("levels",(),"character","placeholder","Show level guidance."),
cm("get",("take","pickup","grab"),"object","implemented","Pick up an item."),cm("drop",(),"object","implemented","Drop an item."),cm("put",(),"object","placeholder","Put an object somewhere."),cm("give",(),"object","placeholder","Give an object to someone."),cm("wear",(),"equipment","implemented","Wear equipment."),cm("remove",("rem",),"equipment","implemented","Remove equipment."),cm("wield",(),"equipment","implemented","Wield a weapon."),cm("hold",(),"equipment","implemented","Hold an item."),cm("eat",(),"object","placeholder","Eat something."),cm("drink",(),"object","placeholder","Drink something."),cm("taste",(),"object","placeholder","Taste something."),cm("fill",(),"object","placeholder","Fill a container."),cm("pour",(),"object","placeholder","Pour from a container."),cm("open",(),"interaction","placeholder","Open something."),cm("close",(),"interaction","placeholder","Close something."),cm("lock",(),"interaction","placeholder","Lock something."),cm("unlock",(),"interaction","placeholder","Unlock something."),cm("pick",(),"interaction","placeholder","Pick a lock."),cm("read",(),"object","placeholder","Read something."),cm("use",(),"object","placeholder","Use something."),cm("identify",("id",),"object","placeholder","Identify an object."),
...
*[cm(x,(),"builder","future_builder",f"{x} is future Builder Mode work.",phase="Builder Mode",builder=True) for x in "redit oedit medit zedit qedit aedit olc".split()],
*[cm(x,(),"admin","future_admin",f"{x} is a future/admin command.",phase="Admin",admin=True) for x in "goto load purge stat vnum wizhelp transfer restore set dig".split()],
