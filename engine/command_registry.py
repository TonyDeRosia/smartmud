...
cm("look",("l","glance"),"informational","implemented","Look around or at a target.", usage="look [target]"),cm("desc",(),"builder","implemented","Builder Mode alias for rdesc.",builder=True, usage="desc <description>"),cm("scan",(),"informational","implemented","Scan nearby rooms for visible actors.", usage="scan [direction]"),cm("examine",("exa",),"informational","implemented","Examine a target.", usage="examine <target>"),cm("exits",(),"informational","placeholder","List visible exits."),cm("score",("sc",),"informational","implemented","Display your character sheet summary."),cm("attributes",(),"informational","implemented","Show canonical primary attributes."),cm("stats",(),"informational","implemented","Alias for attributes."),cm("combatstats",(),"informational","implemented","Show canonical combat stat projection."),cm("statbreakdown",(),"informational","implemented","Show stat breakdown diagnostics."),cm("worth",(),"informational","implemented","Show carried gold."),cm("needs",(),"survival","implemented","Show hunger, thirst, fatigue, nutrition, hydration, and satiation.", usage="needs [status]"),cm("hunger",(),"survival","implemented","Show hunger status."),cm("thirst",(),"survival","implemented","Show thirst status."),cm("fatigue",(),"survival","implemented","Show fatigue status."),cm("food",(),"survival","implemented","Show food and satiation status."),cm("eat",(),"survival","implemented","Eat an exact carried consumable item.", usage="eat <item>"),cm("drink",(),"survival","implemented","Drink an exact carried consumable item or show drink status.", usage="drink [status|item]"),cm("consume",(),"survival","implemented","Consume an exact carried consumable item.", usage="consume <item>"),cm("sip",(),"survival","implemented","Sip from a drink item.", usage="sip <item>"),cm("properties",(),"property","implemented","List your property summary."),cm("property",(),"property","implemented","Inspect, rent, buy, renew, terminate, and manage property.", usage="property <available|info|rent|buy|renew|terminate|access|grant|revoke|guests|invite|remove|storage>"),cm("locker",(),"property","implemented","Use personal lockers.", usage="locker [list|store|retrieve]"),cm("store",(),"property","implemented","Store an item in property storage.", usage="store <item> [container]"),cm("retrieve",(),"property","implemented","Retrieve an item from property storage.", usage="retrieve <item> [container]"),cm("home",(),"property","implemented","Show or set property home location.", usage="home [set|clear]"),cm("keys",(),"property","implemented","List property keys and credentials."),cm("key",(),"property","implemented","Inspect a property key.", usage="key inspect <item>"),cm("inventory",("inv","i"),"informational","implemented","List carried items."),cm("equipment",("eq",),"informational","implemented","Show worn and wielded equipment."),cm("affects",("aff",),"informational","implemented","List detailed active affects."),cm("saff",("shortaff",),"informational","implemented","Compact active affect summary."),cm("spellup",(),"informational","implemented","List active self-buffs."),cm("resists",("resistances",),"informational","implemented","Show resistance placeholders."),cm("skills",("sk",),"character","implemented","List known skills."),cm("spells",("sp",),"magic","implemented","List known spells."),cm("abilities",(),"character","implemented","List available abilities."),cm("ability",(),"character","implemented","Show an ability.", usage="ability <name>"),cm("cooldowns",(),"combat","implemented","Show ability cooldowns."),cm("cancel",(),"combat","implemented","Cancel current cast."),cm("commands",("cmds",),"system","implemented","List available commands."),cm("help",("h",),"system","implemented","Show help for a command."),cm("save",("asave","bsave","wsave","rsave"),"system","implemented","Save character state or builder drafts.", usage="save"),cm("who",(),"informational","implemented","List online players."),cm("whoami",(),"informational","implemented","Show your account and character roles."),cm("where",(),"informational","placeholder","Show your current location."),cm("recall",(),"movement","placeholder","Return to a recall location."),cm("weather",(),"informational","placeholder","Show local weather."),cm("time",(),"informational","placeholder","Show world time."),cm("consider",("con",),"combat","implemented","Assess a target without starting combat."),cm("diagnose",(),"combat","implemented","Assess a target's condition."),cm("levels",(),"character","placeholder","Show level guidance."),
cm("get",("take","pickup","grab"),"object","implemented","Pick up an item.", usage="get <object>"),cm("drop",(),"object","implemented","Drop an item.", usage="drop <object>"),cm("put",(),"object","placeholder","Put an object somewhere.", usage="put <item> <container>"),cm("give",(),"object","placeholder","Give an object to someone.", usage="give <item> <target>"),cm("wear",(),"equipment","implemented","Wear equipment.", usage="wear <item>"),cm("remove",("rem",),"equipment","implemented","Remove equipment.", usage="remove <item>"),cm("wield",(),"equipment","implemented","Wield a weapon.", usage="wield <item>"),cm("hold",(),"equipment","implemented","Hold an item.", usage="hold <item>"),cm("taste",(),"object","placeholder","Taste something."),cm("fill",(),"object","placeholder","Fill a container."),cm("pour",(),"object","placeholder","Pour from a container."),cm("open",(),"interaction","placeholder","Open something."),cm("close",(),"interaction","placeholder","Close something."),cm("lock",(),"interaction","placeholder","Lock something."),cm("unlock",(),"interaction","placeholder","Unlock something."),cm("pick",(),"interaction","placeholder","Pick a lock."),cm("read",(),"object","placeholder","Read something.", usage="read <target>"),cm("use",(),"object","implemented","Use an ability or object.", usage="use <ability> [target]"),cm("identify",("id",),"object","placeholder","Identify an object.", usage="identify <target>"),
cm("quit",(),"system","implemented","Quit session command."),cm("logout",(),"system","implemented","Logout session command."),cm("disconnect",(),"system","implemented","Disconnect session command."),cm("reconnect",(),"system","implemented","Reconnect session command."),cm("restart",(),"system","implemented","Restart session command."),cm("say",(),"communication","implemented","Say something."),cm("greet",(),"communication","implemented","Greet an NPC through the conversation service.", usage="greet <npc>"),cm("tell",(),"communication","placeholder","Tell another player."),cm("reply",(),"communication","placeholder","Reply to a tell."),cm("ask",(),"communication","placeholder","Ask about a topic."),cm("whisper",(),"communication","placeholder","Whisper."),cm("emote",(),"social","implemented","Perform an emote."),cm("gossip",(),"communication","placeholder","Global gossip channel."),cm("auction",(),"economy","future_economy","Auction channel.",phase="Economy"),cm("shout",(),"communication","placeholder","Shout."),cm("holler",(),"communication","placeholder","Holler."),cm("socials",(),"social","implemented","List socials."),cm("social",(),"social","implemented","Perform the social social."),cm("hug",(),"social","implemented","Perform the hug social."),cm("highfive",(),"social","implemented","Perform the highfive social."),cm("wave",(),"social","implemented","Perform the wave social."),cm("smile",(),"social","implemented","Perform the smile social."),cm("laugh",(),"social","implemented","Perform the laugh social."),cm("bow",(),"social","implemented","Perform the bow social."),cm("nod",(),"social","implemented","Perform the nod social."),cm("shake",(),"social","implemented","Perform the shake social."),cm("dance",(),"social","implemented","Perform the dance social."),cm("cheer",(),"social","implemented","Perform the cheer social."),cm("clap",(),"social","implemented","Perform the clap social."),cm("salute",(),"social","implemented","Perform the salute social."),cm("spit",(),"social","implemented","Perform the spit social."),cm("glare",(),"social","implemented","Perform the glare social."),cm("thank",(),"social","implemented","Perform the thank social."),cm("practice",("prac","pr"),"character","implemented","Practice with a trainer.", usage="practice [lesson]"),cm("train",("tr",),"character","implemented","Train with a trainer.", usage="train [lesson]"),cm("buypractice",("buyprac",),"character","implemented","Buy one practice session with Glory.", usage="buypractice"),cm("buytrain",(),"character","implemented","Buy one training session with Glory.", usage="buytrain"),cm("spellbook",(),"magic","future_magic","Spellbooks are future magic work.",phase="Magic"),cm("study",(),"character","placeholder","There is nothing here to study."),
cm("brief",(),"toggle","implemented","Toggle brief room descriptions."),cm("compact",(),"toggle","implemented","Toggle compact output."),cm("autoexits",(),"toggle","implemented","Toggle automatic exits."),cm("autoloot",(),"toggle","placeholder","Store autoloot preference; loot is future combat work."),cm("autogold",(),"toggle","placeholder","Store autogold preference; gold loot is future economy work."),cm("autosplit",(),"toggle","placeholder","Store autosplit preference; groups/economy are future work."),cm("automap",(),"toggle","placeholder","Store automap preference; automap rendering is future work."),cm("norepeat",(),"toggle","placeholder","Toggle norepeat preference."),cm("notell",(),"toggle","placeholder","Toggle tell blocking."),cm("nosummon",(),"toggle","placeholder","Toggle summon blocking."),cm("afk",(),"toggle","implemented","Toggle AFK status."),cm("prompt",(),"toggle","implemented","Configure the persistent Smart MUD prompt."),
cm("display",(),"toggle","implemented","Configure display width and theme preferences."),
cm("displaytheme",(),"builder","implemented","Builder display theme authoring commands.",builder=True),
...
# Guildlands runtime acceptance commands route through canonical services.
*[cm(x,(),"gathering","implemented",f"{x} gathering command.",phase="Gathering",usage=x) for x in "resources survey resource gather forage harvest mine chop fish dig excavate salvage skin butcher extract".split()],
*[cm(x,(),"quest","implemented",f"{x} quest command.",phase="Quests",usage=x) for x in "quests questlog journal quest talk greet reply accept decline abandon turnin progress objectives".split()],
*[cm(x,(),"economy","implemented",f"{x} economy command.",phase="Economy",usage=x) for x in "shop list buy sell value appraise services".split()],
*[cm(x,(),"reward","implemented",f"{x} reward/loot command.",phase="Rewards",usage=x) for x in "loot claim rewards rewardhistory".split()],
*[cm(x,(),"property","implemented",f"{x} property command.",phase="Property",usage=x) for x in "rent storage".split()],

# Phase 11B canonical perception, stealth, search, tracking, scent, and sound.
*[cm(x,(),"interaction" if x not in {"stealth","secrets","discovered","perception","awareness"} else "informational","implemented",f"{x} perception command.",phase="Perception",usage=x) for x in "hide unhide stealth search investigate track tracks listen smell conceal reveal secrets discovered perception awareness".split()],
*[cm(x,(),"builder","implemented",f"{x} perception Builder/Admin command.",phase="Perception",builder=True,usage=x) for x in "senseprofilelist senseprofilestat senseprofilecreate senseprofileclone senseprofileset senseprofiledelete senseprofilevalidate perceptionprofilelist perceptionprofilestat perceptionprofilecreate perceptionprofileset perceptionprofiledelete perceptionprofilevalidate concealmentlist concealmentstat concealmentcreate concealmentset concealmentdelete concealmentvalidate searchprofilelist searchprofilestat searchprofilecreate searchprofileset searchprofiledelete searchprofilevalidate trackingprofilelist trackingprofilestat trackingprofilecreate trackingprofileset trackingprofiledelete trackingprofilevalidate soundprofilelist soundprofilestat soundprofilecreate soundprofileset soundprofiledelete soundprofilevalidate perceptiontrace hidetrace searchtrace trackingtrace trailtrace soundtrace soundpropagationtrace scenttrace secrettrace knowledgetrace perceptionreveal perceptionforget trailcreate trailclear soundemit perceptionaudit".split()],
