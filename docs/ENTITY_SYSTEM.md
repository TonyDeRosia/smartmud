...
## Phase 5B identity distinction

Entity templates remain immutable reusable definitions. Runtime entity instances are persistent individuals with instance IDs, rooms, schedule state, needs, goals, memories, relationships, custom state, and plugin data stored in SQLite.
