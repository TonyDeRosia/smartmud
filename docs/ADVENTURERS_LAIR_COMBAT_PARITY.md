...
## Phase 15B.12 TBA audit note

TBA-style combat uses room character lists and audience-specific `act()` outputs. Smart MUD deliberately extends flee into a Dexterity-primary, level-secondary contest with 5%-95% clamps rather than claiming exact TBA parity for flee probability.
